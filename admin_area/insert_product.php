...
if (isset($_POST['submit'])) {
	...
	move_uploaded_file($tmp_name1, "product_images/check/$product_img1");
	move_uploaded_file($tmp_name2, "product_images/check/$product_img2");
	move_uploaded_file($tmp_name3, "product_images/check/$product_img3");

	$insert_product="INSERT INTO products(p_cat_id, cat_id, date, product_tile, product_img1, product_img2, product_img3, product_price, product_desc, product_keyword) values('$product_cat','$cat',NOW(),'$product_tile','$product_img1','$product_img2','$product_img3','$product_price','$product_desc','$product_keywords')";
